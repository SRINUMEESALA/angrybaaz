                ...
                <div className="d-none d-md-block">
                    <div className="navParentCon d-flex justify-content-center text-white">
                        <div className="navbarCon d-flex justify-content-between">
                            <h1 className="pt-2 pb-2"><span className="text-danger">ANGRY</span>BAAZ</h1>
                            <div className="d-flex">
                                <ul className="list-unstyled d-flex m-0">
                                    {navItems.map(eachItem => <li className={activeTab === eachItem.id ? "mr-3 bg-danger p-2 d-flex align-items-center" : "mr-3 d-flex align-items-center"} key={eachItem.id}><span>{eachItem.item}</span></li>)}
                                </ul>
